Write-Host "Prod_CICD_Projects_Install.ps1 - V1.0.0"
Write-Host "This script adds CodeBuild Projects to the Prod account to implement CI/CD."
Write-Host "This script assumes you have created an organization with Mgmt and Prod accounts"

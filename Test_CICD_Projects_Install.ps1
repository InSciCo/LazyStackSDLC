Write-Host "Test_CICD_Projects_Install.ps1 - V1.0.0"
Write-Host "This script adds CodeBuild Projects to the Test account to implement CI/CD."
Write-Host "This script assumes you have created an organization with Mgmt and Test accounts"
...
Write-Host "Please Test and confirm the following:"
